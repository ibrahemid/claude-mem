...
The Worker Service is an Express HTTP server that handles all claude-mem operations. It runs on port 37778 (configurable via `CLAUDE_MEM_WORKER_PORT`) and is managed by Bun.
